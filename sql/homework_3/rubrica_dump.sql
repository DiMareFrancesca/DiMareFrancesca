...
insert into  user (id,name,surname,telnumber,smartphone) values
                    (1,'mario','rossi', '333789654', 11),
                    (2,'pinco','pallino','328741964',8),
                    (3,'carlo','verdi', '366987412', 10),
                    (4,'francesco','vietri', '340125987', 2),
                    (5,'francesca','di mare', '328631428', 3),
                    (6,'francesca','conti','325987416',6),
                    (7,'luigi','rombi','331456981', 9),
                    (8,'simona','palumbo','321456987', 3),
                    (9,'laura', 'chiatti', '698745321', 1);