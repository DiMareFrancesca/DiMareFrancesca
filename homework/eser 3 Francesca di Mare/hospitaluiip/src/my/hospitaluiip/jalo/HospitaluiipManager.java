...
/**
 * This is the extension manager of the Hospitaluiip extension.
 */
public class HospitaluiipManager extends GeneratedHospitaluiipManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(HospitaluiipManager.class);
	 ...
	 */
	public static HospitaluiipManager getInstance()
	{
		return (HospitaluiipManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(HospitaluiipConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public HospitaluiipManager() // NOPMD 
	{
		LOG.debug("constructor of HospitaluiipManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of HospitaluiipManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of HospitaluiipManager called, current tenant: {}", getTenant().getTenantID());
	}
