...
public class DefaultHospitaluiipService implements HospitaluiipService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultHospitaluiipService.class);
	...
	{
		return DefaultHospitaluiipService.class.getResourceAsStream("/hospitaluiip/sap-hybris-platform.png");
	}
