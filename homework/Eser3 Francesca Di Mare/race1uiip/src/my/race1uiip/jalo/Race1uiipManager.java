...
/**
 * This is the extension manager of the Race1uiip extension.
 */
public class Race1uiipManager extends GeneratedRace1uiipManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(Race1uiipManager.class);
	 ...
	 */
	public static Race1uiipManager getInstance()
	{
		return (Race1uiipManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(Race1uiipConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Race1uiipManager() // NOPMD 
	{
		LOG.debug("constructor of Race1uiipManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of Race1uiipManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of Race1uiipManager called, current tenant: {}", getTenant().getTenantID());
	}
