...
public class DefaultRace1uiipService implements Race1uiipService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultRace1uiipService.class);
	...
	{
		return DefaultRace1uiipService.class.getResourceAsStream("/race1uiip/sap-hybris-platform.png");
	}
